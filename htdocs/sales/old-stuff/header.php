...
<div class="row horizontal align-items-center green">
        ...
        <div class="mb-2 d-flex justify-content-center mt-3">
            <div class="row horizontal align-items-center">
                ...
                <div class="col-6 vertical">
                    <div class="mb-4 d-flex justify-content-center">
                        <a href="https://www.skof.se" target="_top"><img src="../bilder/skofdekal.gif" width="83" height="81" alt="skof dekal"></a>
                    </div>
                </div>
                <div class="col-6 vertical">
                    <div class="mb-4 d-flex justify-content-center">
