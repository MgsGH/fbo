                    ...
                    <form id="edit-box">
                        ...
                        <div id="modalMainEditSection">
                            ...
                            <div class="form-group-sm col-md-4">
                                <label class="control-label" for="inpType" id="lblInpType"></label>
                                <input type="text" id="inpType" required class="form-control input-sm">
                                <div class="text-alert"><small id="warningInpType"></small></div>
                            </div>
