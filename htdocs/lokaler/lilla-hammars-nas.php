...
$sectionMenu->setLillaHammarsNasSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('hammar-header') ?></h2>
                <p><?= $texts->getTxt('hammar-1') ?></p>
                <p><?= $texts->getTxt('hammar-2') ?></p>
                <p><?= $texts->getTxt('hammar-3') ?></p>
            </div>

            <div class="std">
                <br>
                <p><?= $texts->getTxt('hammar-4') ?></p>
                <p><?= $texts->getTxt('hammar-5') ?></p>
                <p></p>
            </div>
