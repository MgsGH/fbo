...
$sectionMenu->setHamnvagenSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('hamn-vagen-header') ?></h2>
                <p><?= $texts->getTxt('hamn-vagen-1') ?></p>
                <p><?= $texts->getTxt('hamn-vagen-2') ?></p>
                <p><?= $texts->getTxt('hamn-vagen-3') ?></p>
                <p><?= $texts->getTxt('hamn-vagen-4') ?></p>
                <p><?= $texts->getTxt('hamn-vagen-5') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/lh_08_pgb.jpg" class="shadow">
            </div>
        </div>
