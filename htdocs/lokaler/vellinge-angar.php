...
$sectionMenu->setVellingeAngarSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('vellinge-header') ?></h2>
                <p><?= $texts->getTxt('vellinge-1') ?></p>
                <p><?= $texts->getTxt('vellinge-2') ?></p>
                <p><?= $texts->getTxt('vellinge-3') ?></p>
                <p><?= $texts->getTxt('vellinge-4') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/vellingeangar_jah.jpg" class="shadow" alt="Vellinge ängar, små öar och vatten">
            </div>
        </div>
