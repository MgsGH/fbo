...
$sectionMenu->setInreFotevikenSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('fote-header') ?></h2>
                <p><?= $texts->getTxt('fote-1') ?></p>
                <p><?= $texts->getTxt('fote-2') ?></p>
            </div>
            <div class="std mr-3">
                <br>
                 <img src="/bilder/inrefoteviken_pgb.jpg" class="shadow" alt="Bild på lokalen">
            </div>
