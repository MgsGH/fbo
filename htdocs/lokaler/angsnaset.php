...
$sectionMenu->setAngsnasetSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('angsnaset-header') ?></h2>
                <p><?= $texts->getTxt('angsnaset-1') ?></p>
                <p><?= $texts->getTxt('angsnaset-2') ?></p>
                <p><?= $texts->getTxt('angsnaset-3') ?></p>
                <p><?= $texts->getTxt('angsnaset-4') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/angsnaset5508_pgb.jpg" class="shadow" alt="Bild på ängsnäset">
            </div>
