...
$sectionMenu->setSkanorSidanSelected();
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                ...
                <h2><?= $texts->getTxt('skanor-sidan-header') ?></h2>

                <p><?= $texts->getTxt('skanor-sidan-1') ?></p>
                <h3><?= $texts->getTxt('vag-beskrivningar') ?></h3>
                <p><?= $texts->getTxt('skanor-sidan-2') ?></p>
                <p><?= $texts->getTxt('skanor-sidan-3') ?></p>
                <p><?= $texts->getTxt('skanor-sidan-4') ?></p>
                <p><?= $texts->getTxt('skanor-sidan-5') ?></p>
                <p><?= $texts->getTxt('skanor-sidan-6') ?></p>
                <p><?= $texts->getTxt('skanor-sidan-7') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/skanorsidan_sve.jpg" class="shadow" alt="Karta">
            </div>
        </div>
