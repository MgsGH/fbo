...
$sectionMenu->setBakdjupetSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('bakdjupet-header') ?></h2>
                <p><?= $texts->getTxt('bakdjupet-1') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/bakdjupet1_0529_lk.jpg" class="shadow" alt="Bild på Bakdjupet">
            </div>
