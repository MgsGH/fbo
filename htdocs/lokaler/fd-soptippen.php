...
$sectionMenu->setfdSoptippenSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('fd-soptippen-header') ?></h2>
                <p><?= $texts->getTxt('fd-soptippen-1') ?></p>
                <p><?= $texts->getTxt('fd-soptippen-2') ?></p>
                <p><?= $texts->getTxt('fd-soptippen-3') ?></p>
                <p><?= $texts->getTxt('fd-soptippen-4') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/soptippen_se.jpg" class="shadow" alt="Bild på området">
            </div>
