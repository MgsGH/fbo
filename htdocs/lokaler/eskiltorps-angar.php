...
$sectionMenu->setEskiltorpsAngarSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('eskil-header') ?></h2>
                <p><?= $texts->getTxt('eskil-1') ?></p>
                <p><?= $texts->getTxt('eskil-2') ?></p>
                <p><?= $texts->getTxt('eskil-3') ?></p>
            </div>

            <div class="st mr-3">
                <br>
                <img src="/bilder/eh_2009.jpg" class="shadow" alt="Bild på ängarna">
            </div>
