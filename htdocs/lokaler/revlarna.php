...
$sectionMenu->setRevlarnaSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('revlarna-header') ?></h2>
                <p><?= $texts->getTxt('revlarna-1') ?></p>
                <p><?= $texts->getTxt('revlarna-2') ?></p>
                <p><?= $texts->getTxt('revlarna-3') ?></p>
                <p><?= $texts->getTxt('revlarna-4') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/revla_flyg_bh.jpg" class="shadow" alt="Flygbild övder området tagen från norr">
            </div>
        </div>
