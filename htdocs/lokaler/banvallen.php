...
$sectionMenu->setBanvallenSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('banvallen-header') ?></h2>

                <p><?= $texts->getTxt('banvallen-1') ?></p>
                <p><?= $texts->getTxt('banvallen-2') ?></p>
                <p><?= $texts->getTxt('banvallen-3') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/banvallen_080626.jpg" class="shadow" alt="Bild på banvallen">
            </div>
        </div>
