...
$sectionMenu->setSkanorsParkSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('skanors-park-header') ?></h2>
                <p><?= $texts->getTxt('skanors-park-1') ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder//skanorpark.jpg" class="shadow" alt="Träd i parken">
            </div>
