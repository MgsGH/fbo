...
$sectionMenu->setKolabackenSelected();
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <h2><?= $texts->getTxt('kolabacken-header'); ?></h2>
                <p><?= $texts->getTxt('kolabacken-1'); ?></p>
                <p><?= $texts->getTxt('kolabacken-2'); ?></p>
            </div>

            <div class="std mr-3">
                <br>
                <img src="/bilder/kolabacken_pgb.jpg" class="shadow" alt="Vy söderut från backen">
            </div>
