...
class StrackTexter
{
    ...
    function getTextsSv(){
        ...
        $texts = array(
            ...
            'intro-ii' => 'Omräknade summor används vid visningen av långsiktiga trender (se <a href="/strack/miljo-overvakning/">Miljöövervakning</a>). ',
            'foto' => 'Foto:',
            'ar' => 'År',
            'Summa' => 'Summa',
            'summa' => 'summa',
            ...
            'info-antal-1' => 'Till och med idag har',
            'info-antal-2' => 'fåglar räknats från Nabben sedan starten 1973.',
            ...
            'mo-intro-2' => 'Alla höstar är de samma, men ingen höst är som någon annan. Data varierar därför mellan åren. Med hjälp av statistiska metoder kan man analysera dessa data och skapa solid information. Resultaten visar att vissa arter ökar och att andra minskar. Även tiden för ankomst och bortflyttning ändras för vissa arter. Detta i sin tur är värdefullt för vidare analyser - vad driver dessa förändring?',
            'mo-intro-3' => 'Här i sektionen "Sträck - Miljöövervakning" presenterar vi resultatet av de trendanalyser som görs löpande baserat på sträckräkningsdata. Samma typ av analyser görs även av ringmärkningsdata. ',
    ...
    function getTextsEn(){
        ...
        $texts = array(
            ...
            'intro-ii' => 'For long time trends adjusted figures are used, (more here - <a href="/strack/miljo-overvakning/?lang=en">environmental monitoring</a>). ',
            'foto' => 'Photo:',
            'ar' => 'Year',
            'summa' => 'sum',
            'Summa' => 'Sum',
            ...
            'info-antal-1' => 'Until today (inclusive)',
            'info-antal-2' => 'birds have been counted at Nabben since the start in 1973.',
            ...
            'mo-intro-2' => 'All autumns are the same, and no autumn is as any other. Due to this, data ta varies between years. With the help of statistic methods this variation can be analyzed and solid information can be generated. Not surprisingly, results shows that some species are doing very well, while others are diminishing. Also the timing of the migration is changing for some species. However, these changes are not consistent across species. This, in turn, is very useful information for further studies - what drives those changes?',
