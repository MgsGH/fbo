...
function writeStrackYearTable($texts, $data){
    ?>
    ...
    <table class="table table-striped table-hover table-sm">
        ...
        foreach($data as $aSpecies):
            ...
            if ($aSpecies['SNR'] != 996) {
                ...
                echo '<td class="' . $artClass .'">' . $aSpecies['NAMN'] . '</td>';
                echo '<td class="' . $tdClass . '">' . formatNo($aSpecies['AUG']) . '</td>';
                echo '<td class="' . $tdClass . '">' . formatNo($aSpecies['SEP']) . '</td>';
                echo '<td class="' . $tdClass . '">' . formatNo($aSpecies['OCT']) . '</td>';
                echo '<td class="' . $tdClass . '">' . formatNo($aSpecies['NOV']) . '</td>';
                echo '<td class="' . $tdClass . '">' . formatNo($aSpecies['TOT']) . '</td>';;
                echo '<td class="' . $tdClass . '">' . formatNo($aSpecies['MV']) . '</td>';
                echo '</tr>';
            }
        ...
        <tr>
            ...
            <td class="<?php echo $artClass ?> summa"><?php echo $texts->getTxt('Summa') ?></td>
            <td class="<?php echo $tdClass ?> summa"><?php echo (formatNo($sumAug)) ?></td>
            <td class="<?php echo $tdClass ?> summa"><?php echo (formatNo($sumSep)) ?></td>
            <td class="<?php echo $tdClass ?> summa"><?php echo (formatNo($sumOct)) ?></td>
            <td class="<?php echo $tdClass ?> summa"><?php echo (formatNo($sumNov)) ?></td>
            <td class="<?php echo $tdClass ?> summa"><?php echo (formatNo($sumSum)) ?></td>
            <td class="<?php echo $tdClass ?> summa"><?php echo (formatNo($sumAve)) ?></td>
