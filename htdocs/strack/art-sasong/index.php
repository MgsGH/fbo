...
$pageMetaData->setAdditionalJavaScriptFiles('art-sasong.js');
...
?>
    ...
    <div class="basePage">
        ...
        <div class="d-flex mt-2">
            ...
            <div class="std">
                <div>
                    <h3><?= $texts->getTxt('header-ar-sasong') ?></h3>
                </div>
                ...
                <div class="pt-2">
                    <?php writeArtToppTable($texts, $dagSummor, $commonSpeciesName) ?>
                </div>
